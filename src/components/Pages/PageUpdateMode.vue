...
<template>
            <div class="py-10 ">
                ...
                <ManualDfuModal :open="open">
                    <button @click="open = false" type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-durablue px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-duraaccent transition duration-300 focus:outline-none sm:text-sm">Cancel</button>
                    <button @click="machine.send('SKIP')" type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-duraaccent px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-durablue transition duration-300 focus:outline-none sm:text-sm">Understood</button>
                </ManualDfuModal>
