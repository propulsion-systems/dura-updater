...
<template>
    <header class="bg-durablue shadow">
        <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold leading-tight text-center text-white">LinkTouch Updater {{ step }} </h1>
            <div class="mx-4 p-6 pt-10">
                <div class="flex items-center">
                    ...
                    <NavigationItem index="2" :step="step" name="Updating" :error="error">
                    ...
                    <NavigationItem index="3" :step="step" name="Done" :error="error">
